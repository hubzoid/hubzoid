...
JEV = register(Capability(
    ...
    description=("Use call_jev in chat for typed decisions from Jev. Each call is billed "
                 "to the hub's JEV_OPENROUTER_API_KEY."),
    surfaces=("chat",), requires=("JEV_OPENROUTER_API_KEY",), missing="Jev key missing",
))
JEV_PERMISSION = JEV.permission
TOOL_NAME = "call_jev"
