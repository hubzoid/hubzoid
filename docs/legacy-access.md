# Legacy Access control: per-role tool gating

This guide applies only to hubs that have not activated managed access. For new
hubs use [access-management.md](access-management.md); for migration use
